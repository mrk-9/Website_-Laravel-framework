...
class BuyerResetPasswordTest extends TestCase
{
   ...
   /**
    ...
    public function testPostResetEmailOk()
    {
    	...
    	$this->post(route('main.password.email.reset'), self::$valid_data);
    ...
    public function testPostResetEmailUserKo()
    {
    	...
    	$this->post(route('main.password.email.reset'), self::$unvalid_data);
    ...
    public function testPostResetPasswordOk()
    {
        ...
        $this->post(route('main.password.reset'), self::$valid_data);
        $this->assertResponseOk();
    }
}
